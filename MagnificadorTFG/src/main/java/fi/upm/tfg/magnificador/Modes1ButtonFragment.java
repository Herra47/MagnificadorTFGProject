 ...
 * displays dummy text.
 */
public class Modes1ButtonFragment extends Fragment {
    /**
    ...
    public static Modes1ButtonFragment newInstance(int option, int index, Colors menuColor) {

        // Instantiate a new fragment
        Modes1ButtonFragment fragment = new Modes1ButtonFragment();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_modes1_button, container, false);
        final Button optionButton = (Button) rootView.findViewById(R.id.optionButtonModes);
        final ImageButton previousItem = (ImageButton) rootView.findViewById(R.id.imageButtonLeftModes);
        final ImageButton nextItem = (ImageButton) rootView.findViewById(R.id.imageButtonRightModes);
            ...
            public void onClick(View view) {
                switch (index){
                    ...
                    case 3:
                        ...
                        //Creamos el Intent
                        Intent intent4 = new Intent(getActivity(),MagnificadorActivity.class);
                        //Comenzamos la nueva actividad
