 ...
 * displays dummy text.
 */
public class CameraSettings1ButtonFragment extends Fragment {
    /**
    ...
    public static CameraSettings1ButtonFragment newInstance(int option, int index, Colors menuColor) {

        // Instantiate a new fragment
        CameraSettings1ButtonFragment fragment = new CameraSettings1ButtonFragment();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_camera_settings1_button, container, false);
        final Button optionButton = (Button) rootView.findViewById(R.id.optionButtonCamera);
        final ImageButton previousItem = (ImageButton) rootView.findViewById(R.id.imageButtonLeftCamera);
        final ImageButton nextItem = (ImageButton) rootView.findViewById(R.id.imageButtonRightCamera);

        optionButton.setText(getResources().getString(option));

        final ViewPager viewPager = CameraSettings1ButtonActivity.getViewPager();
            ...
            public void onClick(View view) {
                switch (index){
                    ...
                    case 0:
                        ...
                        //Creamos el Intent
                        Intent intent1 = new Intent(getActivity(),MagnificadorActivity.class);
                    ...
                    case 1:
                        ...
                        //Creamos el Intent
                        Intent intent2 = new Intent(getActivity(),MagnificadorActivity.class);
                        //Comenzamos la nueva actividad
                    ...
                    case 2:
                        ...
                        //Creamos el Intent
                        Intent intent3 = new Intent(getActivity(),MagnificadorActivity.class);
                        //Comenzamos la nueva actividad
    ...
    public void contrastBlackWhite(Button mainButton, ImageButton buttonLeft, ImageButton buttonRight, ViewPager viewPager){
        ...
        buttonRight.setImageDrawable(index==2 ?
